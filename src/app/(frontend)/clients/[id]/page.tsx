                    ...
                    <div className="space-y-8 relative z-10">
                        <div className="bg-[#0A192F]/50 p-6 md:p-8 rounded-tr-[2.5rem] rounded-bl-[2.5rem] border border-white/5 shadow-inner">
                            <h4 className="text-white font-bold text-sm mb-4 flex items-center gap-2">
                                <span className="text-pharaohGold text-base">𓂀</span> الخدمات والحلول البرمجية المقدمة
                            </h4>
                        ...
                        {client.websiteUrl && (
                            <div className="flex justify-end pt-4 border-t border-pharaohGold/10">
                                <a 
                                    ...
                                    className="bg-gradient-to-r from-pharaohGold to-amber-600 text-[#0A192F] font-black text-sm px-10 py-4 rounded-xl shadow-xl hover:shadow-pharaohGold/10 hover:opacity-95 transition duration-300 transform active:scale-95"
                                >
                                    زيارة موقع الشريك الإلكتروني 🔗
                                </a>
                            </div>
                        )}
                    </div>
