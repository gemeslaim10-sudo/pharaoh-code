  ...
  return (
    <div className="h-screen w-full bg-[#0A192F] flex items-center justify-center">
      <div className="bg-white/5 border border-white/10 p-10 rounded-3xl backdrop-blur-md max-w-md w-full text-center">
        ...
        <p className="text-gray-400 mb-10">تسجيل الدخول للإدارة</p>
        
        <button 
          onClick={loginWithGoogle}
          className="w-full bg-white hover:bg-gray-100 text-gray-800 font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-3 transition-colors"
        >
