    ...
    return (
        <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label className="block text-gray-400 text-sm mb-2.5 font-medium">اسم العميل أو المؤسسة (بالعربية)</label>
                ...
                <div>
                    <label className="block text-gray-400 text-sm mb-2.5 font-medium">اسم العميل (بالإنجليزية - Name EN)</label>
                    <input type="text" value={nameEn} onChange={e => setNameEn(e.target.value)} placeholder="e.g. Nile Real Estate Corp" className="w-full bg-pharaohNavy border border-white/10 rounded-xl p-3.5 text-white focus:border-pharaohGold outline-none transition placeholder:text-gray-600" dir="ltr" />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="url" value={websiteUrl} onChange={e => setWebsiteUrl(e.target.value)} placeholder="https://example.com" required className="w-full bg-pharaohNavy border border-white/10 rounded-xl p-3.5 text-white focus:border-pharaohGold outline-none transition placeholder:text-gray-600" dir="ltr" />
                </div>
                <div>
                    <label className="block text-gray-400 text-sm mb-2.5 font-medium">شعار اللوجو أو هوية المؤسسة <span className="text-pharaohGold text-xs">(600x350 بكسل)</span></label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label className="block text-gray-400 text-sm mb-2.5 font-medium">وصف الخدمة والحلول (بالعربية)</label>
                ...
                <div>
                    <label className="block text-gray-400 text-sm mb-2.5 font-medium">وصف الخدمة (بالإنجليزية - Description EN)</label>
                    <textarea value={descriptionEn} onChange={e => setDescriptionEn(e.target.value)} rows={3} placeholder="Write service description in English..." className="w-full bg-pharaohNavy border border-white/10 rounded-xl p-3.5 text-white focus:border-pharaohGold outline-none transition placeholder:text-gray-600" dir="ltr"></textarea>
                </div>
            </div>
        </>
    );
