                            ...
                            {clients.map((client) => (
                                <tr key={client.id} className="border-b border-white/5 hover:bg-white/5 transition">
                                    ...
                                    <td className="px-6 py-4 text-center space-x-2 space-x-reverse">
                                        <button onClick={() => onEdit(client)} className="text-xs text-pharaohGold bg-pharaohGold/10 px-3 py-1.5 rounded-full hover:bg-pharaohGold hover:text-[#0A192F] transition">
                                            تعديل ✏️
                                        </button>
                                        <button onClick={() => onDelete(client.id)} className="text-xs text-red-400 bg-red-400/10 px-3 py-1.5 rounded-full hover:bg-red-400 hover:text-white transition">
                                            حذف ❌
                                        </button>
                                    </td>
                                </tr>
