  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          <label className="block text-xs font-bold text-gray-400 mb-2">رابط فيسبوك (Facebook)</label>
          <input
            type="url"
            id="social-fb"
            value={formData.fb}
        ...
        <div>
          <label className="block text-xs font-bold text-gray-400 mb-2">رابط انستجرام (Instagram)</label>
          <input
            type="url"
            id="social-ig"
            value={formData.ig}
