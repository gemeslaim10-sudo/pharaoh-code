    ...
    return (
        <div className="bg-pharaohNavy/50 p-6 rounded-2xl border border-white/5 space-y-4">
            <div className="flex justify-between items-center mb-2">
                ...
                <button type="button" onClick={onAddStat} className="bg-pharaohGold/10 hover:bg-pharaohGold/20 border border-pharaohGold/30 text-pharaohGold font-bold text-xs px-3 py-1.5 rounded-lg transition-all duration-300 flex items-center gap-1">
