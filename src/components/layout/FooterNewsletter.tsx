  ...
  return (
    <div>
      ...
      <div className="relative group">
        ...
        <button className="absolute left-2 top-2 bottom-2 bg-[#C5A16F] text-[#0A192F] px-4 rounded-xl font-black text-xs hover:bg-white transition-all">{t("footer.subscribeBtn")}</button>
      </div>
    </div>
  );
}
