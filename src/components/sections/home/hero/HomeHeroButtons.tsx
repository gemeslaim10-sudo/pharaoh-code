    ...
    <div className="flex flex-wrap items-center justify-center gap-3.5 sm:gap-5">
      ...
      >
        ...
        >
          ...
          <span className="relative z-10 tracking-wide whitespace-nowrap shrink-0">{discoverText}</span>
          <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0 transition-transform group-hover:translate-x-1 duration-300 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        ...
        >
          ...
          <span className="relative z-10 tracking-wide whitespace-nowrap shrink-0">{contactText}</span>
          <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0 transition-transform group-hover:translate-x-1 duration-300 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
