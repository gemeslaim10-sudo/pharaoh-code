  ...
  return (
    <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-12 gap-4 sm:gap-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link
          href="/services"
          className={`inline-flex items-center gap-2 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-xl font-bold text-xs border transition-all duration-300 group shadow-md whitespace-nowrap shrink-0 ${
            isLight
