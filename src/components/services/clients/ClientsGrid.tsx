...
export default function ClientsGrid({ clients }: { clients: ClientItem[] }) {
  ...
  return (
    <section className="relative py-32 bg-[#0A192F] overflow-hidden min-h-screen" dir={direction}>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center mb-20 relative">
                ...
                <h2 className="text-4xl md:text-6xl font-black text-white">
                    {t("clients.titlePart1")} <span className="text-[#C5A16F]">{t("clients.titlePart2")}</span>
                </h2>
