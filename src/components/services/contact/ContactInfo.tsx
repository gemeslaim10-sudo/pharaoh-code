        ...
        <div className="relative z-10 flex items-start gap-4">
          ...
          <div>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.96 }}
              className="inline-flex items-center gap-2 bg-[#25D366] text-white px-5 py-2 rounded-xl text-xs font-bold hover:bg-[#1aad52] transition-colors duration-300 shadow-[0_4px_15px_rgba(37,211,102,0.25)]"
            >
