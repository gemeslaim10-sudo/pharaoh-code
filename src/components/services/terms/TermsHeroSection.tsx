...
export default function TermsHeroSection() {
  ...
  return (
    <section className="relative pt-40 pb-12 overflow-hidden" dir={direction}>
        <div
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
            <h2
                className="text-[#C5A16F] font-bold tracking-[0.2em] uppercase text-xs mb-3">
                Pharaoh Code Terms & Conditions
            </h2>
            <h1
                ...
                <span className="text-[#C5A16F] italic">
                    {language === 'ar' ? 'والأحكام العامة' : 'Conditions'}
                </span>
            </h1>
            <div
